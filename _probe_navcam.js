...
(async () => {
  ...
  await page.screenshot({ path: 'nav-visual-check2.png' });
  await browser.close();
  await new Promise(r=>setTimeout(r,11000));await page.screenshot({path:'nav-visual-check2.png'});console.log('done');
