        ...
        {routeLine ? (
          <Mapbox.ShapeSource id="route-line-source" shape={routeLine}>
            <Mapbox.LineLayer
              ...
              style={{ lineColor: map3d.routeLine, lineWidth: 18, lineBlur: 10, lineOpacity: 0.22, lineCap: 'round', lineJoin: 'round' }}
            />
            <Mapbox.LineLayer
              id="route-line-glow"
              style={{ lineColor: map3d.routeLine, lineWidth: 10, lineBlur: 4, lineOpacity: 0.45, lineCap: 'round', lineJoin: 'round' }}
            />
            <Mapbox.LineLayer
              id="route-line"
              style={{ lineColor: map3d.routeLine, lineWidth: 4.5, lineOpacity: 1, lineCap: 'round', lineJoin: 'round' }}
            />
          </Mapbox.ShapeSource>
        ) : null}
